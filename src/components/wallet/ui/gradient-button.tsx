...
/**
 * Composant bouton avec dégradé réutilisable - Thème SLATE
 ...
 *
 * Gradients adaptés au thème SLATE:
 * - from-slate-700 to-slate-800 (pack standard)
 * - from-amber-400 to-amber-500 (pack populaire - gold)
 */
