...
const STATE_BADGE_CLASSES: Record<MonsterState, string> = {
  happy: 'bg-emerald-50 text-emerald-800 ring-1 ring-inset ring-emerald-300',
  sad: 'bg-blue-50 text-blue-800 ring-1 ring-inset ring-blue-300',
  angry: 'bg-red-50 text-red-800 ring-1 ring-inset ring-red-300',
  hungry: 'bg-amber-50 text-amber-900 ring-1 ring-inset ring-amber-300',
  sleepy: 'bg-slate-100 text-slate-700 ring-1 ring-inset ring-slate-300'
}
